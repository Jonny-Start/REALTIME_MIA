...
export function ConsolePage() {
  ...
  /**
   * Handle messages from the parent window JONNY
   * - connect: connect to conversation
   * - disconnect: disconnect from conversation
  ...
  //Apenas corra la pagina se conecta a la conversacion en modo automatico
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    client.addTool(
      {
        name: 'send_course',
        description: 'Submit course data',
        parameters: {
          type: 'object',
          properties: {
            //curso solicitado
            requested_course: {
              type: 'string',
              description:
                'Clear and concise text on the topic you want to learn about.Always use lowercase, no other characters.',
            },
            //objetivo
            objective: {
              type: 'string',
              description: 'The objective of the course is two options, quick basics of the subject or clarify technical doubts and/or go deeper.',
            },
            //Formato
            format: {
              type: 'string',
